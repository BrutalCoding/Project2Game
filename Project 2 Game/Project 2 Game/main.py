...
playerLabels = selectScreen.makePlayerLabels(players, Option, font, screen)
...
labelAmountPlayers = selectScreen.makeBotLabels(generateID, maxAmountOfBots, font, screen, Option)
